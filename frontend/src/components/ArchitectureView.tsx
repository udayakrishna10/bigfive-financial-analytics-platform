...
import { CheckCircle2, XCircle, ArrowRight, Cloud, Database, DollarSign, Wrench, Shield, Sparkles, Activity } from 'lucide-react';
...
export const ArchitectureView = () => {
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-6">
            ...
            {/* Header */}
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-900 dark:via-slate-900 dark:to-blue-950 p-6 rounded-3xl border border-blue-100 dark:border-blue-900/30 shadow-xl shadow-blue-500/5">
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-gray-200 dark:border-white/10 bg-gradient-to-r from-gray-50 to-slate-50 dark:from-slate-800/50 dark:to-slate-900/50">
                                <th className="p-6 text-gray-700 dark:text-slate-300 font-bold text-sm uppercase tracking-wider pl-8">Feature</th>
                                <th className="p-6 text-red-700 dark:text-red-300 font-bold text-sm uppercase tracking-wider">
                                ...
                                <th className="p-6 text-emerald-700 dark:text-emerald-300 font-bold text-sm uppercase tracking-wider">
                                    <div className="flex flex-col gap-1.5">
                                        <div className="flex items-center gap-2">
                                ...
                                <th className="p-6 text-blue-700 dark:text-blue-300 font-bold text-sm uppercase tracking-wider">
                                    <div className="flex flex-col gap-1.5">
                                        <div className="flex items-center gap-2">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-white/5 text-sm">
                            <tr className="hover:bg-blue-50/50 dark:hover:bg-white/5 transition-all duration-200 group">
                                <td className="p-6 pl-8 text-gray-900 dark:text-slate-200 font-semibold flex items-center gap-3">
                                    <Cloud size={20} className="text-blue-500/70 group-hover:text-blue-500 transition-colors" />
                                    Compute
                                </td>
                                <td className="p-6 text-gray-600 dark:text-slate-400 bg-red-500/5 dark:bg-red-900/10">GKE Autopilot (Always-On)</td>
                                <td className="p-6 text-emerald-700 dark:text-emerald-200 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 to-emerald-600" />
                                    Cloud Run Jobs (Scale-to-Zero)
                                </td>
                                <td className="p-6 text-blue-700 dark:text-blue-200 font-bold bg-blue-500/5 relative">
                            ...
                            <tr className="hover:bg-blue-50/50 dark:hover:bg-white/5 transition-all duration-200 group">
                                ...
                                <td className="p-6 text-gray-600 dark:text-slate-400 bg-red-500/5 dark:bg-red-900/10">Apache Airflow (Cloud Composer)</td>
                                <td className="p-6 text-emerald-700 dark:text-emerald-200 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 to-emerald-600" />
                            ...
                            <tr className="hover:bg-blue-50/50 dark:hover:bg-white/5 transition-all duration-200 group">
                                ...
                                <td className="p-6 text-gray-600 dark:text-slate-400 bg-red-500/5 dark:bg-red-900/10">Monolithic BigQuery Storage</td>
                                <td className="p-6 text-emerald-700 dark:text-emerald-200 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 to-emerald-600" />
                            ...
                            <tr className="hover:bg-blue-50/50 dark:hover:bg-white/5 transition-all duration-200 group">
                                ...
                                <td className="p-6 text-red-700 dark:text-red-300 font-semibold bg-red-500/5 dark:bg-red-900/10">High (~$100+/month idle fees)</td>
                                <td className="p-6 text-emerald-700 dark:text-emerald-200 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 to-emerald-600" />
                            ...
                            <tr className="hover:bg-blue-50/50 dark:hover:bg-white/5 transition-all duration-200 group">
                                ...
                                <td className="p-6 text-gray-600 dark:text-slate-400 bg-red-500/5 dark:bg-red-900/10">Manual / Cloud Build</td>
                                <td className="p-6 text-emerald-700 dark:text-emerald-200 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 to-emerald-600" />
                            ...
                            <tr className="hover:bg-blue-50/50 dark:hover:bg-white/5 transition-all duration-200 group">
                                ...
                                <td className="p-6 text-gray-600 dark:text-slate-400 bg-red-500/5 dark:bg-red-900/10">Cluster & Node Management</td>
                                <td className="p-6 text-emerald-700 dark:text-emerald-200 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 to-emerald-600" />
                            ...
                            <tr className="hover:bg-blue-50/50 dark:hover:bg-white/5 transition-all duration-200 group">
                                ...
                                <td className="p-6 text-gray-600 dark:text-slate-400 bg-red-500/5 dark:bg-red-900/10">Continuous Streaming / High Traffic</td>
                                <td className="p-6 text-emerald-700 dark:text-emerald-200 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 to-emerald-600" />
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-slate-900 dark:via-slate-900 dark:to-purple-950 border border-purple-100 dark:border-purple-900/30 p-10 rounded-3xl shadow-2xl shadow-purple-500/10">
                <div className="absolute inset-0 bg-grid-slate-100 dark:bg-grid-slate-800 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.6))] dark:[mask-image:linear-gradient(0deg,rgba(255,255,255,0.1),rgba(255,255,255,0.05))]" style={{ backgroundSize: '30px 30px' }}></div>
                <div className="relative">
                    <div className="mb-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-8">
                        ...
                        <div className="flex flex-col items-center group">
                            <h3 className="text-lg font-black bg-gradient-to-r from-blue-600 to-blue-700 dark:from-blue-400 dark:to-blue-500 bg-clip-text text-transparent mb-3 text-center">Market Data</h3>
                            <p className="text-xs text-gray-700 dark:text-slate-300 text-center leading-tight mb-3 font-medium">yFinance + FRED + CoinGecko</p>
                            <div className="px-3 py-1.5 bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-600 dark:to-blue-700 rounded-xl text-[10px] text-white font-mono font-bold text-center shadow-lg shadow-blue-500/30">OHLCV + MACRO + CRYPTO</div>
                        </div>
                        ...
                        <div className="flex flex-col items-center group">
                            ...
                            <div className="px-3 py-1.5 bg-gradient-to-r from-pink-500 to-pink-600 dark:from-pink-600 dark:to-pink-700 rounded-xl text-[10px] text-white font-mono font-bold text-center shadow-lg shadow-pink-500/30">GLOBAL SENTIMENT</div>
                        </div>
            ...
            {/* Security & Governance */}
            <div className="bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-slate-900 dark:via-slate-900 dark:to-emerald-950 p-10 rounded-3xl border border-emerald-100 dark:border-emerald-900/30 shadow-xl shadow-emerald-500/5">
                <h3 className="text-2xl font-black bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400 bg-clip-text text-transparent mb-8 flex items-center gap-3">
                    <Shield className="text-emerald-500" size={24} />
                    Security & Governance
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white dark:bg-slate-800/50 p-6 rounded-2xl border border-emerald-200 dark:border-emerald-900/30 shadow-sm hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-900 dark:to-purple-950 p-10 rounded-3xl border border-purple-100 dark:border-purple-900/30 shadow-xl shadow-purple-500/5">
                <h3 className="text-2xl font-black bg-gradient-to-r from-purple-600 to-blue-600 dark:from-purple-400 dark:to-blue-400 bg-clip-text text-transparent mb-8 flex items-center gap-3">
                    <Wrench size={24} className="text-purple-500" />
                    Engineering Lifecycle & CI/CD
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white dark:bg-slate-800/50 p-8 rounded-2xl border border-purple-200 dark:border-purple-900/30 shadow-sm hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300">
                    ...
                    <div className="bg-white dark:bg-slate-800/50 p-8 rounded-2xl border border-blue-200 dark:border-blue-900/30 shadow-sm hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300">
                    ...
                    <div className="bg-white dark:bg-slate-800/50 p-8 rounded-2xl border border-emerald-200 dark:border-emerald-900/30 shadow-sm hover:shadow-lg hover:shadow-emerald-500/10 transition-all duration-300">
            ...
            {/* Final Metric Callout */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative overflow-hidden bg-gradient-to-br from-emerald-500 to-blue-600 p-10 rounded-3xl shadow-2xl shadow-emerald-500/30 hover:shadow-emerald-500/40 transition-all duration-300 group">
                    <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative flex items-center justify-between">
                        <div>
                            <h4 className="text-emerald-100 font-bold uppercase tracking-widest text-xs mb-2">Impact Metric</h4>
                            <p className="text-4xl font-black text-white tracking-tight mb-2">97.5% Cost Reduction</p>
                            <p className="text-sm text-emerald-100">From $40/mo (GKE) to ~$1/mo (Cloud Run serverless).</p>
                        </div>
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-purple-500 to-indigo-600 p-10 rounded-3xl shadow-2xl shadow-purple-500/30 hover:shadow-purple-500/40 transition-all duration-300 group">
                    <div className="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                    <div className="relative flex items-center justify-between">
                        <div>
                            <h4 className="text-purple-100 font-bold uppercase tracking-widest text-xs mb-2">System Strategy</h4>
                            <p className="text-4xl font-black text-white tracking-tight mb-2">Zero-Ops Managed</p>
                            <p className="text-sm text-purple-100">Fully automated, decoupled serverless architecture.</p>
                        </div>
                        <div className="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center shadow-xl">

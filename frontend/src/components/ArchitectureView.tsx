...
export const ArchitectureView = () => {
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            {/* Comparison Table */}
            <div className="overflow-hidden rounded-3xl border border-white/10 shadow-2xl bg-slate-900/40 backdrop-blur-sm">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-white/10 bg-white/5">
                                <th className="p-4 py-5 text-slate-400 font-semibold text-sm uppercase tracking-wider pl-8">Feature</th>
                                <th className="p-4 py-5 text-red-300/80 font-bold text-sm uppercase tracking-wider flex items-center gap-2">
                                    <XCircle size={16} /> Phase 1: Enterprise Native (GKE)
                                </th>
                                <th className="p-4 py-5 text-emerald-300 font-bold text-sm uppercase tracking-wider">
                        ...
                        <tbody className="divide-y divide-white/5 text-sm">
                            <tr className="hover:bg-white/5 transition-colors group">
                                <td className="p-5 pl-8 text-slate-300 font-medium flex items-center gap-3">
                                    <Cloud size={18} className="text-blue-500/50 group-hover:text-blue-400 transition-colors" />
                                    Compute
                                </td>
                                <td className="p-5 text-slate-400">GKE Autopilot (Always-On)</td>
                                <td className="p-5 text-emerald-100 font-medium bg-emerald-500/5 relative">
                            ...
                            <tr className="hover:bg-white/5 transition-colors group">
                                ...
                                <td className="p-5 text-slate-400">Apache Airflow (Cloud Composer)</td>
                                <td className="p-5 text-emerald-100 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-emerald-500/50" />
                            ...
                            <tr className="hover:bg-white/5 transition-colors group">
                                ...
                                <td className="p-5 text-slate-400">Monolithic BigQuery Storage</td>
                                <td className="p-5 text-emerald-100 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-emerald-500/50" />
                            ...
                            <tr className="hover:bg-white/5 transition-colors group">
                                ...
                                <td className="p-5 text-red-300 font-semibold">High (~$100+/month idle fees)</td>
                                <td className="p-5 text-emerald-300 font-bold bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-emerald-500/50" />
                            ...
                            <tr className="hover:bg-white/5 transition-colors group">
                                ...
                                <td className="p-5 text-slate-400">Cluster & Node Management</td>
                                <td className="p-5 text-emerald-100 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-emerald-500/50" />
                            ...
                            <tr className="hover:bg-white/5 transition-colors group">
                                ...
                                <td className="p-5 text-slate-400">Continuous Streaming / High Traffic</td>
                                <td className="p-5 text-emerald-100 font-medium bg-emerald-500/5 relative">
                                    <div className="absolute left-0 top-0 bottom-0 w-1 bg-emerald-500/50" />

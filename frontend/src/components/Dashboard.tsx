    ...
    <div className="flex flex-col h-full space-y-5">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-slate-900 dark:via-slate-900 dark:to-blue-950 p-5 rounded-2xl border border-blue-100 dark:border-blue-900/30 shadow-lg shadow-blue-500/5 flex-shrink-0">
        ...
        <div className="relative">
          <h2 className="text-xl font-black bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent mb-3">Tech Stocks</h2>
            ...
            {techStocks.map((s, i) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  ...
                  <div className={`p-1.5 rounded-lg ${s.daily_return >= 0 ? 'bg-emerald-500/10 text-emerald-500' : 'bg-rose-500/10 text-rose-500'}`}>
                    {s.daily_return >= 0 ? <TrendingUp size={16} /> : <TrendingDown size={16} />}
                  </div>
                </div>
      ...
      {/* Crypto Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-slate-900 dark:via-slate-900 dark:to-purple-950 p-5 rounded-2xl border border-purple-100 dark:border-purple-900/30 shadow-lg shadow-purple-500/5 flex-shrink-0">
        <div className="absolute inset-0 bg-grid-slate-100 dark:bg-grid-slate-800 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.6))] dark:[mask-image:linear-gradient(0deg,rgba(255,255,255,0.1),rgba(255,255,255,0.05))]" style={{ backgroundSize: '30px 30px' }}></div>
        <div className="relative">
          <h2 className="text-xl font-black bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 dark:from-purple-400 dark:via-pink-400 dark:to-indigo-400 bg-clip-text text-transparent mb-3">Crypto Markets</h2>
          <CryptoCards onTickerSelect={onTickerSelect} historicalData={cryptoStocks} />
        </div>
      </div>
